# [AREA_NAME] — Claude Code area scope

> **Where to put this**: `[AREA_DIR]/CLAUDE.md` (e.g. `backend/CLAUDE.md`, `frontend/CLAUDE.md`, `migrations/CLAUDE.md`).
> **Why nested**: Claude loads the closest `CLAUDE.md` for a given file. A nested file gives area-specific routing without polluting the root entry point.
